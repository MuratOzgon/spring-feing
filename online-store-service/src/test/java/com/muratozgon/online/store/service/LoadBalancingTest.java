...
public class LoadBalancingTest {
    ...
    public static class TestConfig {
        ...
        public ServiceInstanceListSupplier serviceInstanceListSupplier() {
            return new TestServerInstanceListSupplier("user-session-service", 8082, 9092);
        }
    }

    @RegisterExtension
    static WireMockExtension USER_SESSION_SERVICE1 = WireMockExtension.newInstance()
            .options(WireMockConfiguration.wireMockConfig().port(8082))
            .build();

    @RegisterExtension
    static WireMockExtension USER_SESSION_SERVICE2 = WireMockExtension.newInstance()
    ...
    public void testLoadBalancingForUserSessionServiceWorks() throws Exception {
        ...
        USER_SESSION_SERVICE1.stubFor(get(urlPathEqualTo("/user-sessions/validate"))
                .withQueryParam("sessionId", equalTo("828bc3cb-52f0-482b-8247-d3db5c87c941"))
                .willReturn(okJson(responseBody)));

        USER_SESSION_SERVICE2.stubFor(get(urlPathEqualTo("/user-sessions/validate"))
                .withQueryParam("sessionId", equalTo("828bc3cb-52f0-482b-8247-d3db5c87c941"))
